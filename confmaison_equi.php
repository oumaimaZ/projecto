                ...
                <div class="col-lg-2">
                  ...
                  <div class="col-md-2">
                    <select class="form-control" name="piece[]"> 
                     ...
                     $sql='SELECT  p.* FROM piece p,maison m where m.id_maison=p.maison and m.id_maison="'.$_SESSION['id_maison'].'" 
