...
<!-- Modal -->
<div id="view_clime" class="modal fade" role="dialog">
        ...
        <div id="holder">
            <div class="form-group">
              ...
              <div class="col-md-12">
                ...
                $sql="SELECT *,p.nom as piece ,e.nom as equip FROM equipement e, piece p where p.id_piece=e.piece and e.type='climatiseur' and maison=?";
         ...
         while($ligne = $query->fetch())
             ...
             echo "<div class='panel-body '>";
                ...
                echo "<label class='control-label col-md-5' for='portail'>climatiseur: ".$ligne['equip']."</label>";
                
                echo " <label class='control-label col-md-5'' for='portail'>   ".$etat." :".$connect."</label>";
