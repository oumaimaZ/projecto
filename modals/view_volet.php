...
<!-- Modal -->
<div id="view_volet" class="modal fade" role="dialog">
 <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title">Volets </h3>
      </div>
        ...
        <div id="holder">
            <div class="form-group">
              ...
              <div class="col-md-12">
                ...
                $sql="SELECT *,p.nom as piece ,e.nom as equip FROM equipement e, piece p where p.id_piece=e.piece and e.type='volet' and maison=?";
         ...
         while($ligne = $query->fetch())
             ...
             echo "<div class='panel-body '>";
                ...
                echo "<label class='control-label col-md-4' for='alarme'>volet: ".$ligne['equip']."</label>";
